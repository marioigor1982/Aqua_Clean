...
const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { href: "#pricing", text: "Serviços", hoverColor: "hover:text-[#b9cc01]", underlineColor: "bg-[#b9cc01]" },
    { href: "#about", text: "Sobre Nós", hoverColor: "hover:text-[#00eaff]", underlineColor: "bg-[#00eaff]" },
